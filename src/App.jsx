...
export const App = () => {
  ...
  <div className='h-screen w-screen flex justify-center items-center flex-col bg-gray-100'>
    ...
    <div className='flex flex-col space-y-5 w-full max-w-md p-6 bg-white rounded-lg shadow-lg'>
      <input className='bg-amber-200 border border-gray-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-400' type='text' placeholder='Nombre tarea' />
      <textarea className='bg-amber-200 border border-gray-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-400' placeholder='Descripción'></textarea>
    ...
    <div className='w-full max-w-md mt-4'>
            <div className='bg-white border border-gray-300 p-4 rounded-lg shadow-md flex items-start space-x-3 mt-2'>
              ...
              <div>
                <p className='font-bold'>holaaaaaa</p>
                <p className='text-gray-600'>holaaaaaaaaaaaaaaaaaaaaa</p>
              </div>
            </div>
        </div>
    {/* <div>
